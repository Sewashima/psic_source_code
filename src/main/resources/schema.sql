...
CREATE TABLE IF NOT EXISTS consultation_times (
    id INT AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS physician_rooms (
    id INT AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS physician_expertise (
    id INT AUTO_INCREMENT PRIMARY KEY,
    physician_id VARCHAR(100) NOT NULL,
    expertise_id VARCHAR(100) NOT NULL,
    created_at VARCHAR(100) NULL DEFAULT CURRENT_TIMESTAMP,
    updated_at VARCHAR(100) NULL DEFAULT CURRENT_TIMESTAMP
);
